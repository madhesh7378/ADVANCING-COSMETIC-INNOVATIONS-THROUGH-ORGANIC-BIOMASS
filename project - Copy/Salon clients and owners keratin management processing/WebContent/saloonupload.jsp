...
<title>Saloon Owner Upload</title>
 <title>Saloon Owner File Upload</title>
...
<h1>FILE UPLOAD</h1>
    <div class="agile-its">
        <h2>File Upload</h2>
        <div class="w3layouts">
            <p>Upload Your File To Send The Dataset Report </p>
            <div class="photos-upload-view">
                <form id="upload" action="SaloonUpload" method="POST" enctype="multipart/form-data">
                ...
                <div style="float: right;">
                    <a href="saloonhome.jsp" class="cancel-btn">Cancel</a>
                </div>
            </div>
