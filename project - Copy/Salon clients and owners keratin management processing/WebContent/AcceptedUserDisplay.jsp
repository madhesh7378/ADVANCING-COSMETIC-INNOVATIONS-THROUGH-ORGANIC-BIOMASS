...
<style>
   ...
   /* input[type="submit"] {
    ...
    td a:hover, input[type="submit"]:hover {
...
String qry = "select * from employee_status";
        ...
        <div class="wrapper">
            <div class="main-cover w3">
                    ...
                    <tbody>
                        ...
                        <tr>
                           <!--  <td><%= rs.getString(1) %></td>--> 
                            ...
                            <td><a href="adminpay.jsp">Pay Amount</a></td>
                            <form action="RejectPay" method="Post">
               ...
               <div style="text-align: center;">
                <a href="adminselect.jsp" class="back-button">Back to Home</a>
                 </div>
                  </div>
        </div>
    </div>
