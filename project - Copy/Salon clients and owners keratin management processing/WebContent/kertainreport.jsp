...
String qry="select * from kertain_report";
    ...
    <div class="covers-main w3layouts">
        <div class="wrapper">
            <div class="main-cover w3">
                <h1>KERATIN REPORT</h1>
                <table>
                    <thead>
                        <tr>
                            <th>BATCH</th>
                            <th>INITIAL PROTEIN(G)</th>
                            <th>TEMPERATURE(°C)</th>
                            <th>REMAINING PROTEIN(G)</th>
                            <th>SOLUBLITY</th>
                            <th>APPERANCE</th>
                            <th>RESULT</th>                  
                        </tr>
                  ...
                  <div style="text-align: center; margin-top: 20px;">
                        <a href="melope.jsp" class="btn btn-primary back-button" role="button">Back to Home</a>
