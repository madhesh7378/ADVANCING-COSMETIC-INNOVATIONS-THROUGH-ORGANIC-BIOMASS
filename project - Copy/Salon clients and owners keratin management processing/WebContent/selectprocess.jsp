...
{
case "melaninereport":
window.location="adminmelanin.jsp";
break;
case "kertainreport":
window.location="adminkertain.jsp";
break;
default:
...
<body>
<h1>PROCESS ANALYSIS REPORT DISPLAY</h1>
<br><div class="form">
...
<center><select style="background: #012B39;font-size : 20px;
  ...
  margin-top: 1em; " name="cause" id="s1" onChange="SelectRedirect();">
				...
				<option value="melaninereport">Melanine Report</option>
				<option value="kertainreport">Kertain Report</option>
	   </select></center>   
</div>

<br><center><a href="adminhomepage.jsp" class="btn btn-primary">Back To Home</a></center>
