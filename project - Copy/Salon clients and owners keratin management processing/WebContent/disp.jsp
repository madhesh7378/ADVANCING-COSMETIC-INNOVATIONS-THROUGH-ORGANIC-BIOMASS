...
<link href='f/css/bootstrap.min.css' media='all' rel='stylesheet'>
<link href="f/css/style.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
    ...
    <script src="f/js/jquery-2.2.3.min.js"></script>
    <script src='f/js/jquery.validate.min.js'></script>
    <script src='f/js/formAnimation.js'></script>
    <script src='f/js/shake.js'></script> 
    <!-- //js -->
</body>
</html>
