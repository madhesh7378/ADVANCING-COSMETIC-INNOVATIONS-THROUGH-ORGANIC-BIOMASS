...
<form action="AnalysisReport" method="post">
<%
Connection conn=Dbconn.getconnection();
HttpSession s=request.getSession();
String mail=(String)s.getAttribute("cmmail");
String qry="select * from accepted_report ";
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <td><%=rs.getString(6) %></td>
                                    <td>  </td>            
   <td><input type="submit" value="Process Report" class="btn btn-primary back-button" style="background-color: blue; color: white; display: inline-block; padding: 10px 20px; text-decoration: none; border-radius: 5px;"></td>
                       <!-- <td><a href="index.html" class="btn btn-primary back-button" style="background-color: blue; color: white; display: inline-block; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Back to Home</a></td> --> 
                 ...
                 <div style="text-align: center;">
                    <a href="processanalysishome.jsp" class="btn btn-primary back-button">Back to Home</a>
                </div>
  </form>                              
                  </div>
            </div>
