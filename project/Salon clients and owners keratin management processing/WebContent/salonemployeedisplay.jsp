...
<title>Saloon Owner Display</title>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="adminreportview.jsp?email=<%=rs.getString(2)%>" class="btn btn-outline-success">View Report</a></td>
                        </tr>
                        <%
...
<a href="adminselect.jsp" class="back-button">Go Back</a>
