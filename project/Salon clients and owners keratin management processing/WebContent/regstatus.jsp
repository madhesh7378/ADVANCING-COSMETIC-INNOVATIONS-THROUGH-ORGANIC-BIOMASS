...
String qry = "SELECT * FROM saloon_owner WHERE email='" + mail + "'";
PreparedStatement ps = conn.prepareStatement(qry);
ResultSet rs = ps.executeQuery();
%>

<h1>SALON OWNER REGISTERED STATUS</h1>
...
<form action="statuscheck.jsp" method="get" style="text-align: center;">
