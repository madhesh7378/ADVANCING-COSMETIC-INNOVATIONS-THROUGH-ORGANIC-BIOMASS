...
<body>
<h1>SALOON OWNER DETAILS AND STATUS</h1>
<table>
<%
...
%>
  <thead>
    <tr>
      ...
      <th style="text-align: center;">Owner Email</th>
  ...
  %>
    <tr style="text-align: center;">
      ...
      %>
    	  <td>
            <a href="adm_venacclog.jsp?shop_name=<%= rs.getString(4) %>&email=<%=rs.getString(2) %>&password=<%= rs.getString(6) %>" 
               class="btn btn-dark" style="pointer-events: none; text-decoration: none; color: black;">Accept</a>
            <br><br>
            <a href="adm_venrejlog.jsp?shop_name=<%= rs.getString(4) %>&email=<%= rs.getString(2) %>" class="btn btn-danger">Reject</a>
          </td>
      <% 
      } else {
      %>
