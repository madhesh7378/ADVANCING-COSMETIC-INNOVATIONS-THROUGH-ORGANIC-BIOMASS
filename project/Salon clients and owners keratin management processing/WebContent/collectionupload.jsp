...
<title>Collection Management Dataset Upload</title>
...
<h1>FILE UPLOAD</h1>
    <div class="agile-its">
        <h2>File Upload</h2>
        <div class="w3layouts">
            <p>Collection Dataset Report </p>
            <div class="photos-upload-view">
                <form id="upload" action="CollectionUpload" method="POST" enctype="multipart/form-data">
                ...
                <div style="float: right;">
                    <a href="collection.jsp" class="action-btn">Cancel</a>
                    </div>
                </div>
            </div>
