...
{
case "shopowner":
window.location="admope.jsp";
break;
case "analysist":
window.location="paope.jsp";
break;
case "management":
window.location="cmope.jsp";
break;
default:
...
<center><select style="background: #012B39;font-size : 20px;
  ...
  margin-top: 1em; " name="cause" id="s1" onChange="SelectRedirect();">
				...
				<option value="analysist">Process Analysis</option>
				<option value="management">Collection management</option>
	   </select></center>   
</div>
